...
final kCategories = [
  Category('USA ', amount: 240.00),
  Category('Brazil', amount: 96.00),
  Category('Russia', amount: 60.00),
  Category('India', amount: 37.00),
  Category('UK', amount: 34.00),
  Category('Others', amount: 423.00),
];
